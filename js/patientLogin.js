...
function StoreDiagonstic(token) {
  fetch("https://praecox.future-developers.cloud/api/Diagnostic/show", {
    ...
    switch (response.status) {
      case 200:
        ...
        var level = body.data[0].Diagnostic_stage;
        var ExersicePage = "";
        switch (level) {
          case "VeryMildDemented":
            ExersicePage="Exercise.html";
            break;

          case "MildDemented":
            ExersicePage="Exercise2.html";
            break;

          case "ModerateDemented":
            ExersicePage="Exercise3.html";
            break;

          default:
            console.log("Invalid diagnosis result");
            break;
        }
		localStorage.setItem('Exersicepage',ExersicePage)
